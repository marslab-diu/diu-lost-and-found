            ...
            <div className="w-11/12 mx-auto flex flex-1 gap-5 overflow-hidden">
                ...
                <aside className="w-58 rounded-3xl bg-base-200 py-4 px-1 mt-3 mb-5">
                    <ul className="admin-nav menu space-y-2 text-base-content w-full">
                        <li>  <NavLink to="/admin/dashboard" end className="flex items-center gap-3 transition-colors hover:bg-base-300">
                            <BsHouseDoor size={22} />
                ...
                {/* Main Content Area */}
                <main className="flex-1 p-1 mt-3 mb-5 overflow-y-auto">
                    <Outlet />
                </main>
            </div>
